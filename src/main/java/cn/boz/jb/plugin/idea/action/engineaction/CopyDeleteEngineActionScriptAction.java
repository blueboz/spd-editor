...
public class CopyDeleteEngineActionScriptAction extends CopyScriptBaseAction {
    ...
    protected String engineTaskSql(EngineTask engineTask) {
        ...
        StringBuilder sqls = new StringBuilder();
        sqls.append(String.format("delete from ENGINE_TASK where ID_='%s';", id));
        sqls.append("\n\n");
        sqls.append(String.format("delete from ENGINE_FLOW where PROCESSID_='%s';", id));
        sqls.append("\n");
        return sqls.toString();
    }
}
