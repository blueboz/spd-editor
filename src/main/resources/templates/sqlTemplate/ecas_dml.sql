...
delete from  ECAS_ACTIONPOWER where POWERBIT=${powerbits?split(',')[0]};
INSERT INTO ECAS_ACTIONPOWER (APPLID, POWERBIT, PATH, DESCRIPTION, ENABLED, MODULENAME, WEIGHT, ENGMODULE, ENGDESC, MENUID)
VALUES (999, ${powerbits?split(',')[0]}, '${namespace}/${className}Input.html', '${functionbase}-A-${title}-修改白名单', 1, '${moduleName}', 3, null, null, 0);

delete from  ECAS_ACTIONPOWER where POWERBIT=${powerbits?split(',')[0]};
INSERT INTO ECAS_ACTIONPOWER (APPLID, POWERBIT, PATH, DESCRIPTION, ENABLED, MODULENAME, WEIGHT, ENGMODULE, ENGDESC, MENUID)
VALUES (999, ${powerbits?split(',')[0]}, '${namespace}/${className}Mod.html', '${functionbase}-A-${title}-修改白名单名称流程', 1, '${moduleName}', 3, null, null, 0);
